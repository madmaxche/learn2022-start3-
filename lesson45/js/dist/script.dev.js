...
// Число
var someNum = 458;
console.log(someNum); // Десяткові числа

var someNums = 4.58;
console.log(someNums); //let someBigNum = 1000000;
//console.log(someBigNum);

var someBigNum = 1e6; //1*1000000

console.log(someBigNum); //let someLittleNum = 0.000001;
//console.log(someLittleNum);

var someLittleNum = 1e-6; //1 / 1000000

console.log(someLittleNum); //Шістнадцятковий, двійковий і восьмирічні числа
...
console.log(num.toString(2)); //Округлення чисел
...
var sourceNum = 1.005 + Number.EPSILON;
var numFour = Math.round(sourceNum * 100) / 100;
console.log(numFour);
console.log(sourceNum * 100);
console.log(Math.round(sourceNum * 100)); //Провірка: isFinite та isNaN
//Провірка isNaN
...
console.log(NaN === NaN); //Провірка isFinite

console.log(isFinite("25"));
console.log(isFinite("Privit!"));
console.log(isFinite(10 / 0)); //parseInt та parseFloat

var valueOne = parseInt("150.58px");
console.log(valueOne);
console.log(_typeof(valueOne));
var valueTwo = parseFloat("150.58px");
console.log(valueTwo);
console.log(_typeof(valueTwo));
console.log(parseInt('0xff', 16));
console.log(parseInt('ff', 16)); //Math.random()
// Повертає псевдовипадкове число в діапазоні від 0(включаючи)
// до 1 (не включаючи 1)

console.log(Math.random());
console.log(Math.random());
console.log(Math.random()); //Math.max(a,b,c....) / Math.min(a,b,c....)
