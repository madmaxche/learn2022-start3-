...
var BLOCK_SIZE = 25;
var COLOR_RED = "#F00"; //Імя константи зі значенням присвоєним в процесі виконання програми

var summSizes = 25 + 30; //Зміна значень в константі
//Об'єкт з данними
...
console.log(userProfile); //Далі я міняю значення одного з полей об'єкта

userProfile.age = 18; //Помилки немає, дані змінились

console.log(userProfile); //КЛЮЧОВЕ СЛОВО VAR
//Області видимості
